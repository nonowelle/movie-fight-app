...
//Add the of the createAutocompleteConfig properties and add them to createAutoComplete to use it with 2 different roots
createAutoComplete({
  ...autocompleteConfig,
...
const movieTemplate = (movieDetail) => {
  ...
  const movieDetailPlot = movieDetail.Plot.slice(0, 160);
  const movieDetailPlotSum = `${movieDetailPlot}...`;
